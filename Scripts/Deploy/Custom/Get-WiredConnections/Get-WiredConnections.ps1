...
$nics = Get-WmiObject -Namespace "root/CIMV2" -Query "SELECT * FROM Win32_NetworkAdapter" | Where-Object {
	($excluded -NotContains $_.NetConnectionStatus) -and ($_.PNPDeviceID -notmatch "ROOT\\NET")
} | ?{
	$_.physicaladapter
}
